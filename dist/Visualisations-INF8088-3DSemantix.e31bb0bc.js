...
},{"core-js/shim":"node_modules/core-js/shim.js","regenerator-runtime/runtime":"node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"node_modules/core-js/fn/regexp/escape.js"}],"src/scripts/preprocess.js":[function(require,module,exports) {
"use strict";
...
exports.getOccurrenceOrder = getOccurrenceOrder;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return fetch("https://pfosaomareastus2.blob.core.windows.net/samuel/VisualisationPoly/Dataset%20A%20-%202022-02-15.json?sv=2020-04-08&st=2022-02-15T19%3A41%3A21Z&se=2022-04-30T18%3A41%3A00Z&sr=b&sp=r&sig=QsR44Y79YEhGR63OaygjFQExZlGA5WMaXya0597KEZI%3D");
          ...
          case 9:
            ...
            throw new Error('An error occurred: ' + _context.t0.message);
...
function getInfoOrders() {
  return _getInfoOrders.apply(this, arguments);
}
/**
...
function _getInfoOrders() {
  _getInfoOrders = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var infoOrders, orders;
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            orders.Orders.forEach(function (order) {
              var counter = 0;
              order.Builds.forEach(function (build) {
                build.BuiltParts.forEach(function (part) {
                  counter += part.Quantity;
                });
              });
              infoOrders.push(counter);
            });
            return _context2.abrupt("return", infoOrders);
...
function getOccurrenceOrder() {
  return _getOccurrenceOrder.apply(this, arguments);
}

function _getOccurrenceOrder() {
  _getOccurrenceOrder = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var orders, orderAndQuantity;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return getInfoOrders();
          ...
          case 2:
            ...
            return _context3.abrupt("return", Object.entries(orderAndQuantity));
...
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js"}],"src/scripts/LineChart/viz.js":[function(require,module,exports) {
"use strict";
...
function labelYName(margin, height, svg) {
  svg.append("text").attr("text-anchor", "middle").style("font-size", "14px").style('font-weight', "bold").attr("transform", "translate(" + (margin.left - 100) + "," + height / 2 + ")rotate(-90)").text("Taille d'une commande");
}
/**
...
function labelXName(width, margin, height, svg) {
  svg.append("text").style("font-size", "14px").style('font-weight', "bold").attr("text-anchor", "middle").attr("transform", "translate(" + width / 2 + "," + (height - (margin.bottom - 74)) + ")").text("Quantité d'une commande");
}
/**
...
function graphTitle(width, margin, svg) {
  svg.append("text").attr("x", width / 2).attr("y", 5 - margin.top / 2).attr("text-anchor", "middle").style('font-weight', "bold").style("font-size", "16px").text("Nombre de pièces en fonction de la taille de la commande");
}
/**
...
function appendToDom(width, height, margin) {
  return d3.select("#curved_line").append("svg").attr("width", width + margin.left + margin.right).attr("height", height + margin.top + margin.bottom).append("g").attr("transform", "translate(" + margin.left + "," + margin.top + ")");
}
/**
...
function drawXAxis(svg, xScale, height) {
  svg.append("g").attr("class", "axis axis--x").attr("transform", "translate(0," + height + ")").call(d3.axisBottom(xScale).scale(xScale).ticks(10));
}
/**
 * Draws the y axis.
 * @param {Object} svg
...
function drawYAxis(svg, yScale) {
  svg.append("g").attr("class", "axis axis--y").call(d3.axisLeft(yScale).scale(yScale).ticks(10));
}
/**
...
function plotCircles(svg, data, x, y) {
  svg.selectAll("myCircles").data(data).enter().append("circle").attr("fill", "black").attr("stroke", "none").attr("cx", function (d) {
    return x(d[0]);
  }).attr("cy", function (d) {
    return y(d[1]);
  }).attr("r", 2);
...
function drawCurveLine(svg, data, x, y) {
  svg.append("path").datum(data).attr("class", "line").attr("fill", "#fff").attr("stroke", "#f2a808").attr("stroke-width", 2).attr("d", d3.line().curve(d3.curveBasis).x(function (d) {
    return x(d[0]);
  }).y(function (d) {
    return y(d[1]);
  }));
...
function drawGraph(data) {
  var _graphDimensions = graphDimensions(),
      _graphDimensions2 = _slicedToArray(_graphDimensions, 3),
      width = _graphDimensions2[0],
      height = _graphDimensions2[1],
      margin = _graphDimensions2[2];

  var svg = appendToDom(width, height, margin);
  var x = XScale(data, width);
  var y = YScale(data, height);
...
},{}],"src/scripts/LineChart/tooltip.js":[function(require,module,exports) {
"use strict";
...
function container(tooltip) {
  tooltip.append("rect").attr("class", "tooltip").attr("width", 200).attr("height", 50).attr("x", 10).attr("y", -22).attr("rx", 4).attr("ry", 4);
}
/**
...
function setContent(tooltip) {
  tooltip.append("text").attr("class", "tooltip-quantity").attr("x", 176).attr("y", 2);
  tooltip.append("text").attr("x", 18).attr("y", 18).text("Taille d'une commande :");
  tooltip.append("text").attr("x", 18).attr("y", 2).text("Quantité d'une commande :");
  tooltip.append("text").attr("class", "tooltip-numberOrder").attr("x", 160).attr("y", 18).text("Taille d'une commande : ");
}
/**
...
function wrapperTooltip(svg, x, y, data, width, height) {
  var tool = tooltip(svg);
  createCircles(tool);
  container(tool);
  setContent(tool);
  eventHandler(svg, tool, x, y, data, width, height);
}
},{}],"src/scripts/RadarChart/radarChart.js":[function(require,module,exports) {
"use strict";
...
var CATEGORIES = ["Pièces réalisés(x1000)", "Machines", "Taille des commandes(x10)", "Procédés", "Matériaux"];
...
function appendToDom(width, height) {
  var svg = d3.select("#radar_chart").append("svg").attr("width", width).attr("height", height);
  return svg; // .append("g")
...
function drawCircles(svg) {
  ...
  for (var i = 0; i < CATEGORIES.length; i++) {
    ...
    var angle = Math.PI / 2 + 2 * Math.PI * i / CATEGORIES.length;
    var line_coordinate = angleToCoordinate(angle, 10);
    var value = i == 1 ? 12 : i == 2 ? 13 : 10.5;
    var label_coordinate = angleToCoordinate(angle, value);
    svg.append("line").attr("x1", 300).attr("y1", 300).attr("x2", line_coordinate.x).attr("y2", line_coordinate.y).attr("stroke", "black");
    svg.append("text").attr("x", label_coordinate.x).attr("y", label_coordinate.y).attr("font-weight", 700).text(category_name);
  }
}
...
function drawDataShape(formattedData, svg) {
  ...
  var coordinates = getPathCoordinates(formattedData);
  console.log(coordinates);
  svg.append("path").datum(coordinates).attr("d", line).attr("stroke-width", 3).attr("stroke", color).attr("fill", color).attr("stroke-opacity", 1).attr("opacity", 0.5);
  svg.append("circle").datum(coordinates).attr("d", line).attr("stroke-width", 3).attr("stroke", color);
}
/**
 * @param {Object[]} the data to be used
 */
...
function drawGraph(data) {
  ...
  var width = 600,
      height = 600,
      margin = 0; //graphDimensions()

  var svg = appendToDom(width, height, margin);
  drawCircles(svg);
  drawDataShape(formattedData, svg);
  return svg; // return [svg, x, y, data, width, height]
} // ["Pièces réalisés", "Machines", "Procédés", "Taille des commandes", "Matériaux"];


function getFormattedData(data) {
  var createdPartsNB = getCreatedPartsNB(data);

  var _getProcessMachineMat = getProcessMachineMaterialSizeNB(data),
      _getProcessMachineMat2 = _slicedToArray(_getProcessMachineMat, 4),
      buildProcessNB = _getProcessMachineMat2[0],
      machineNB = _getProcessMachineMat2[1],
      materialsNB = _getProcessMachineMat2[2],
      avgOrdersSize = _getProcessMachineMat2[3];
...
function getProcessMachineMaterialSizeNB(data) {
  var processesCounted = [];
  var machinesCounted = [];
  var materialsCounted = [];
  var allOrdersSize = [];

  for (var i = 0; i < data.Orders.length; i++) {
    var currentOrder = data.Orders[i];
    var orderSize = 0;

    for (var j = 0; j < currentOrder.Builds.length; j++) {
      var currentBuild = currentOrder.Builds[j];
      ...
      currentBuild.BuiltParts.forEach(function (part) {
  ...
  var sum = 0;
  allOrdersSize.forEach(function (nb) {
    return sum += nb;
  });
  var avgOrdersSize = sum / allOrdersSize.length;
  return [processesCounted.length, machinesCounted.length, materialsCounted.length, avgOrdersSize];
}
},{}],"index.js":[function(require,module,exports) {
"use strict";

var preprocess = _interopRequireWildcard(require("./src/scripts/preprocess.js"));

var viz = _interopRequireWildcard(require("./src/scripts/LineChart/viz.js"));

var tooltips = _interopRequireWildcard(require("./src/scripts/LineChart/tooltip"));

var radar = _interopRequireWildcard(require("./src/scripts/RadarChart/radarChart"));
...
_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
  var data, _viz$drawGraph, _viz$drawGraph2, svg, x, y, d, width, height, rawData;
  ...
  return regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return preprocess.getOccurrenceOrder();

        case 2:
          data = _context.sent;
          _viz$drawGraph = viz.drawGraph(data), _viz$drawGraph2 = _slicedToArray(_viz$drawGraph, 6), svg = _viz$drawGraph2[0], x = _viz$drawGraph2[1], y = _viz$drawGraph2[2], d = _viz$drawGraph2[3], width = _viz$drawGraph2[4], height = _viz$drawGraph2[5];
          tooltips.wrapperTooltip(svg, x, y, d, width, height);
          _context.next = 7;
          return preprocess.getData();
...
},{"./src/scripts/preprocess.js":"src/scripts/preprocess.js","./src/scripts/LineChart/viz.js":"src/scripts/LineChart/viz.js","./src/scripts/LineChart/tooltip":"src/scripts/LineChart/tooltip.js","./src/scripts/RadarChart/radarChart":"src/scripts/RadarChart/radarChart.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/Visualisations-INF8088-3DSemantix.e31bb0bc.js.map